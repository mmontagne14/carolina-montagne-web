...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20200725_carolinamontagne_dbe9a3a7408e1ff63737_20200725175553_archive.zip';
	const ARCHIVE_SIZE		 = '99370620';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'dbe9a3a-25175553';
    const SECONDARY_PACKAGE_HASH = '2894ad7-25175553';
