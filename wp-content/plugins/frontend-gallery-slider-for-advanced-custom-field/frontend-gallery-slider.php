 ...
 * Description: Display Advanced Custom Field Gallery on frontend of your website with shorcode. Also work with Gutenberg shortcode block. 
...
if( !defined( 'FAGSFACF_VERSION' ) ) {
	define( 'FAGSFACF_VERSION', '1.4' ); // Version of plugin
}
...
if( !defined( 'FAGSFACF_POST_TYPE' ) ) {
    define( 'FAGSFACF_POST_TYPE', 'acf-field-group' ); // plugin post type
}
